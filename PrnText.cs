...
namespace Expire
{
	...
	public class PrnText
	{
		...
		e.Graphics.DrawString(getTime()+ " Printed By Drug Expiration Dates App.   http://goo.gl/lH50z " ,smoallFont,Brushes.Black,e.MarginBounds.Left-90,e.MarginBounds.Bottom+50);
